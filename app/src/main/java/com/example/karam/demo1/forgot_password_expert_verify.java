...
public class forgot_password_expert_verify extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forgot_password_expert_verify);

        pin = getIntent().getIntExtra("pin_key" , 0);

        Toast.makeText(forgot_password_expert_verify.this , String.valueOf(pin) , Toast.LENGTH_SHORT).show();
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(s.length() == 1)
                {
...

                    {
                        ...
                        Intent i =new Intent(forgot_password_expert_verify.this ,new_password_expert.class);
