...
public class expert_verify_layout extends AppCompatActivity {
int pin;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_expert_verify_layout);

        pin = getIntent().getIntExtra("pin_key" , 0);

        Toast.makeText(expert_verify_layout.this , String.valueOf(pin) , Toast.LENGTH_SHORT).show();
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(s.length() == 1)
                {
...

                    {
                        ...
                        Intent i =new Intent(expert_verify_layout.this , expert_signup_details.class);
